...
#pragma clang diagnostic ignored "-Wunused-parameter"
    ...
    JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
        ...
        jclass result_class = env->FindClass(
                "com/bumptech/glide/integration/apng/decoder/Apng$DecodeResult");
    ...
    Java_com_bumptech_glide_integration_apng_decoder_ApngDecoderJni_decode(
            JNIEnv *env,
            jclass thiz,
            jobject inputStream,
            jobject result
        ...
        std::shared_ptr<ApngImage> image = std::move(
                ApngDecoder::decode(std::move(source), resultCode));
    ...
    Java_com_bumptech_glide_integration_apng_decoder_ApngDecoderJni_isApng(
            JNIEnv *env,
            jclass thiz,
            jobject inputStream
    ) {
    ...
    Java_com_bumptech_glide_integration_apng_decoder_ApngDecoderJni_draw(
            JNIEnv *env,
            jclass thiz,
            jint id,
            jint index,
    ...
    JNIEXPORT jint JNICALL
    Java_com_bumptech_glide_integration_apng_decoder_ApngDecoderJni_recycle(
            JNIEnv *env,
            jclass thiz,
            jint id
    ) {
    ...
    JNIEXPORT jint JNICALL
    Java_com_bumptech_glide_integration_apng_decoder_ApngDecoderJni_copy(
            JNIEnv *env,
            jclass thiz,
            jint id,
            jobject result
        ...
        env->SetLongField(result, gResult_allFrameByteCountFieldID,
                          copyPtr->getAllFrameByteCount());
