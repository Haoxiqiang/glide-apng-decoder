...
package com.bumptech.glide.integration.apng.decoder
...
import com.bumptech.glide.integration.apng.decoder.ApngDrawable.Companion.decode
import java.io.File
...
class ApngDrawable @VisibleForTesting internal constructor(
    ...
    companion object {
         ...
         */
        @WorkerThread
        fun isApng(res: Resources, @RawRes id: Int): Boolean = try {
